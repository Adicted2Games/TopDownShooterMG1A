package 
{
	...
	public class Main extends Sprite 
	{
		...
		private function init(e:Event = null):void 
		{
			...
			addChild(background);
			background.width = stage.fullScreenHeight
			background.height = stage.fullScreenWidth
		...
		private function createChests():void 
		{
			for (var i:int = 0; i < 5; i++)
			{
				...
				chest.scaleX = chest.scaleY = tank1.scaleX + 0.2;
			}
		}
		...
		private function createBullet(e:ShootEvent):void 
		{
			if (tank1 != null)
			{
				...
				bullets.push(b);
				addChild(b);
				b.scaleX = b.scaleY = tank1.scaleX + 0.5;
			}
		}
